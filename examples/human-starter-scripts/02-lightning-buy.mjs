...
if (!Number.isFinite(AMOUNT) || AMOUNT <= 0) throw new Error('Missing or invalid CORTO_LIGHTNING_BUY_AMOUNT');
...
const payload = {
  ...
  memo: String(process.env.CORTO_LIGHTNING_MEMO || 'human starter script buy'),
